...
<body>
    <div class="container">
        <form action="controllerColaborador.php" method="post" style="text-align:center; margin: 0 auto;">
        <fieldset class="scheduler-border" >
            ...
            <div class="form-group row">
                <label for="dataAdmissao" class="col-sm-2 col-form-label">Data de Admissao</label>
                <div class="col-sm-10">
            ...
            <div>
             <input type="submit" class="btn btn-info btn pull-right" name="Gravar"></input required>
            </div>
